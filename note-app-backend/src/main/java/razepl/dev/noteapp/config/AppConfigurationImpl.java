...
import static razepl.dev.noteapp.config.constants.CorsConfig.API_PATTERN;
import static razepl.dev.noteapp.config.constants.CorsConfig.CONTENT_TYPE_HEADER;
import static razepl.dev.noteapp.config.constants.CorsConfig.CORS_ADDRESSES;
