...
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.NAME_PATTERN_MESSAGE;
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.NAME_SIZE_MESSAGE;
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.PASSWORD_NULL_MESSAGE;
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.SURNAME_NULL_MESSAGE;
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.SURNAME_PATTERN_MESSAGE;
import static razepl.dev.noteapp.entities.user.constants.UserValidationMessages.SURNAME_SIZE_MESSAGE;
